# 🖼️ Museum Art Collection Analysis | Power BI
...
├── data/
│   └── museum_art_collection.csv
├── powerbi/
│   └── Museum_Art_Analysis.pbix
├── video/
│   └── Museum_Art_PowerBI_Demo.mp4
└── README.md

## 🔍 Key Analysis
- Distribution of artworks by classification and medium
...
- Visuals designed to support quick comparison and insights

## 📈 Outcome
This project demonstrates practical Power BI skills, data visualization techniques, and the ability to convert raw data into actionable insights.
